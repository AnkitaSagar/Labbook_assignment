...
public class App {
	...
	private static IEmployeeService eService;
	...
	private static void doAdd() {
		...
		employee.setInsuranceScheme(eService.getInsuranceScheme(employee.getSalary()));
		Integer id = eService.addEmployee(employee);
	...
	private static void doList() {
		...
		employees = (List<Employee>) eService.displayEmployee();
	...
	private static void doSearch() {
		...
		ArrayList<Employee> employees = eService.getEmployee(scheme);
		if (employees.isEmpty()) {
			System.out.println("No employees To display");
		} else {
			for (Employee emp : employees)
	...
	private static void doRemove() {
		...
		boolean isDone = eService.deleteEmployee(id);
		if (isDone) {
